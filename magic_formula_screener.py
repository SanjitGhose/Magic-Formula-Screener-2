...
class MagicFormulaPro:
    ...
    def __init__(self):
        # Load all predefined stocks and indices
        self.all_stocks_info = self._get_indian_stocks_and_indexes_list() or []

        # Data storage
        self.stock_data = {}  # Stores fetched raw data and calculated indicators
        self.screened_results = pd.DataFrame()  # Stores screening results
        self.cache = {}  # Cache for yfinance data
        self.last_fetch_time = {}  # Cache timestamps
